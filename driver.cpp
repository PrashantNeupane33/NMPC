...
// Derivative of bezier at t — used for heading
...
{
	// Define bezier segments
	// Each segment: start, control1, control2, end
	// control points determine curve shape between endpoints
	std::vector<BezierSegment> segments = {
	// crossing over previous path
	...
	// sudden reversal crossing itself
	...
	// sharp right then sudden left reversal
	{0.0,  0.0,   5.0,  0.0,   5.0,  0.0,   5.0,  0.0},
	{5.0,  0.0,   5.0,  0.0,   5.0,  3.0,   2.0,  3.0},
};
	// Compute arc length of each segment for uniform speed
